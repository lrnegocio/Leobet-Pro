  ...
  try {
    const response = await payment.create({
      body: {
        ...
        description: `Recarga LEOBET PRO - ${user.nome}`,
        ...
        notification_url: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://leobet-pro.vercel.app'}/api/webhooks/mercadopago`,
      },
    });
    ...
    throw new Error('Falha ao gerar o PIX. Verifique suas credenciais.');
  }
}
